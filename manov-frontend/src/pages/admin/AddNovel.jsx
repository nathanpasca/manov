...
import { Save, ArrowLeft, Image as ImageIcon, Book, User, Info, Loader } from 'lucide-react';
...
const AddNovel = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error("Error creating novel: " + (err.response?.data?.detail || err.message));
        } finally {
            setLoading(false);
        }
    };
            ...
            >
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-sm">Create a new novel entry manually</p>
                    </div>
                </div>
